...
from Var import ram1 , ram2 , ram3 , p1 , p2 , p3 , score , add , ed ,times , same1 , same2 ,same3 , L_PIC , M_PIC , R_PIC , text_ADD , text_Score , text_Times
from UI import  init , Local , Result_TXT 
